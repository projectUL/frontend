...
function ProfilePage(props) {
  ...
  return (
    <>
      <p className="profilePage_back" onClick={() => props.changePage("applications")}>
      ...
      <div className="profilePage_wrap">
        ...
        <div className="profilePage_courses">
          ...
          <ul>
            {userProfile.skills.courses.map((c, i) => (
              <li key={i}>{c}</li>
            ))}
          </ul>
        </div>
        ...
        <div className="profilePage_expirience">
          ...
          {userProfile.experience.map((e, i) => (
            <ExperienceProfileView exp={e} key={i} />
          ))}
        </div>
        <div className="profilePage_line">
          <div className="square"></div>
        ...
        <div className="profilePage_projects">
          ...
          <div className="profilePage_projects_box">
            {userProfile.projects.map((p, i) => (
              <ProjectViewProfile onClick={closeProjectDisplay} data={p} key={i} />
            ))}
          </div>
        </div>
